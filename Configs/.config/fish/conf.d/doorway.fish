...
alias in='doorway-shell pm install'
alias un='doorway-shell pm remove'
alias up='doorway-shell pm upgrade'
alias pl='doorway-shell pm search installed'
alias pa='doorway-shell pm search all'
alias g='git'
