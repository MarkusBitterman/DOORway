...
alias in='doorwayde-shell pm install'
alias un='doorwayde-shell pm remove'
alias up='doorwayde-shell pm upgrade'
alias pl='doorwayde-shell pm search installed'
alias pa='doorwayde-shell pm search all'
alias g='git'
