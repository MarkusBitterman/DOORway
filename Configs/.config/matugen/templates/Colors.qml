...
// Material You palette extracted from the current wallpaper.
// Output path: ~/.local/share/matugen/Colors.qml
// Phase 12 wires this into the QuickShell module import path.
pragma Singleton
import QtQuick
