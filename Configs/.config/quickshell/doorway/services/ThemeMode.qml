...
Singleton {
    ...
    function writeCartridgeColors() {
        ...
        Quickshell.execDetached(["hyprctl", "keyword", "general:col.active_border", `rgba(${active})`]);
        Quickshell.execDetached(["hyprctl", "keyword", "general:col.inactive_border", `rgba(${inactive})`]);
