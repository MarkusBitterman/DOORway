...
function _slow_load_warning {
    local lock_file="/tmp/.doorwayde_slow_load_warning.lock"
    ...
    ⚠️ Warning: Shell startup took more than ${time_limit} seconds. Consider optimizing your configuration.
        ...
        2. Duplicate plugins initialization.
            ...
            - DOORwayDE already sources the oh-my-zsh.sh file for you.
            - It is important to remove all DOORwayDE related
                configurations from your .zshrc file as DOORwayDE will handle it for you.
