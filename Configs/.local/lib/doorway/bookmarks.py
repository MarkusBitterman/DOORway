...
class XDGPaths:
    def __init__(self):
        ...
        self.CACHE_DIR = os.path.join(self.xdg_cache, "doorway")
        self.CONFIG_DIR = os.path.join(self.xdg_config, "doorway")
        self.RUNTIME_DIR = os.path.join(self.xdg_runtime, "doorway")
        self.DATA_DIR = os.path.join(self.xdg_data, "doorway")
...
class BookmarkManager:
    ...
    def find_bookmark_files(self):
        ...
        # Custom .lst files
        for path in [
            os.path.join(self.xdg.xdg_config, "doorway/bookmarks.lst"),
        ]:
            if os.path.exists(path):
                files.append(path)
        return files
