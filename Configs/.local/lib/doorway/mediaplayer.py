...
def main():
    ...
    config_file = os.path.join(xdg_state_home(), "doorway", "config")
    colors_file = os.path.join(xdg_cache_home(), "doorway/wall.dcol")
    ...
    # You can configure these in ~/.config/doorway/config.toml
