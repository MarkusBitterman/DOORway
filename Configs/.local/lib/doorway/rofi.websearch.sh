...
cached_search_dir="${XDG_CACHE_HOME:-$HOME/.cache}/doorway/landing/websearch"
declare -A SITES SITES_ICON
search_file=(
    "$SHARE_DIR/doorway/websearch.lst"
    "$XDG_CONFIG_HOME/doorway/websearch.lst")
load_search_engines() {
    local lst_files=()
...
main() {
    ...
    argparse_program "doorway-shell rofi.websearch"
    argparse_header "DOORway Web Search"
