...
[[ -f "${XDG_DATA_HOME:-$HOME/.local/share}/doorway/locale/${DESKTOP_LANG}.sh" ]] && source "${XDG_DATA_HOME:-$HOME/.local/share}/doorway/locale/${DESKTOP_LANG}.sh"
[[ -f "${XDG_CONFIG_HOME:-$HOME/.config}/doorway/locale/${DESKTOP_LANG}.sh" ]] && source "${XDG_CONFIG_HOME:-$HOME/.config}/doorway/locale/${DESKTOP_LANG}.sh"
