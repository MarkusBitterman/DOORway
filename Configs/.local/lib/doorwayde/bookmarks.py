...
class XDGPaths:
    def __init__(self):
        ...
        self.CACHE_DIR = os.path.join(self.xdg_cache, "doorwayde")
        self.CONFIG_DIR = os.path.join(self.xdg_config, "doorwayde")
        self.RUNTIME_DIR = os.path.join(self.xdg_runtime, "doorwayde")
        self.DATA_DIR = os.path.join(self.xdg_data, "doorwayde")
...
class BookmarkManager:
    ...
    def find_bookmark_files(self):
        ...
        # Custom .lst files
        for path in [
            os.path.join(self.xdg.xdg_config, "doorwayde/bookmarks.lst"),
        ]:
            if os.path.exists(path):
                files.append(path)
        return files
