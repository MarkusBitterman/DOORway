...
def main():
    ...
    config_file = os.path.join(xdg_state_home(), "doorwayde", "config")
    colors_file = os.path.join(xdg_cache_home(), "doorwayde/wall.dcol")
    ...
    # You can configure these in ~/.config/doorwayde/config.toml
