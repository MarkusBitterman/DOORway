...
def load_toml_file(toml_file):
    try:
        ...
        notify.send("DOORwayDE Error", error_message)
        return None
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=os.path.join(
            xdg_config_home(),
            "doorwayde/config.toml",
        ),
        help="The input TOML file to parse. Default is $XDG_CONFIG_HOME/doorwayde/config.toml",
    )
    parser.add_argument(
        "--env",
        default=os.path.join(
        ...
        help="The output environment file. Default is $XDG_STATE_HOME/doorwayde/config",
    )
    parser.add_argument(
        "--hypr",
        default=os.path.join(
            xdg_state_home(),
            "doorwayde/hyprland.conf",
        ),
