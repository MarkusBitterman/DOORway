...
cached_search_dir="${XDG_CACHE_HOME:-$HOME/.cache}/doorwayde/landing/websearch"
declare -A SITES SITES_ICON
search_file=(
    "$SHARE_DIR/doorwayde/websearch.lst"
    "$XDG_CONFIG_HOME/doorwayde/websearch.lst")
load_search_engines() {
    local lst_files=()
...
main() {
    ...
    argparse_program "doorwayde-shell rofi.websearch"
    argparse_header "DOORwayDE Web Search"
