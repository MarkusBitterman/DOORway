...
[[ -f "${XDG_DATA_HOME:-$HOME/.local/share}/doorwayde/locale/${DESKTOP_LANG}.sh" ]] && source "${XDG_DATA_HOME:-$HOME/.local/share}/doorwayde/locale/${DESKTOP_LANG}.sh"
[[ -f "${XDG_CONFIG_HOME:-$HOME/.config}/doorwayde/locale/${DESKTOP_LANG}.sh" ]] && source "${XDG_CONFIG_HOME:-$HOME/.config}/doorwayde/locale/${DESKTOP_LANG}.sh"
